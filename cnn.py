...
input_shape_cnn = (1, 3, 100, 100)              #batch_size, num_channels, height, width
...
class CNN(nn.Module):
    def __init__(self, input_shape=input_shape_cnn, num_classes=10):
        ...
        # self.act0 = nn.ReLU()
        # self.conv1 = nn.Conv2d(in_channels = 128, out_channels = 32, kernel_size = 3, stride = (1, 1), padding = 'valid')
        # self.act1 = nn.ReLU()
        # self.pool1 = nn.MaxPool2d(kernel_size = (2, 2), stride = (2, 2))
        # self.conv2 = nn.Conv2d(in_channels = 32, out_channels = 64, kernel_size = 3, stride = (1, 1), padding = 'valid')
        # self.act2 = nn.ReLU()
        ...
        self.conv1 = nn.Conv2d(in_channels = 3, out_channels = 3, kernel_size = 3, stride = 1, padding = 0, dilation = 2)
        self.conv2 = nn.Conv2d(in_channels = 3, out_channels = 3, kernel_size = 3, stride = 1, padding = 0, dilation = 2)
